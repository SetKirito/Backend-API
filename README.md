...
> Важно: AI и email — это интеграции с внешними сервисами. Если они недоступны, создание заявки всё равно продолжает работать: контакт сохраняется в базе данных, а ответ возвращается как успешный.
...
- OpenAI API
- Используется для анализа тональности и классификации комментария
...
Финальная логика, проверка поведения, исправление ошибок и адаптация под Docker были выполнены вручную.
